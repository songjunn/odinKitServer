...
// source: MessageDeletePlayer.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "MessageDeletePlayer.pb.h"
...
void protobuf_AssignDesc_MessageDeletePlayer_2eproto() {
  protobuf_AddDesc_MessageDeletePlayer_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "MessageDeletePlayer.proto");
  GOOGLE_CHECK(file != NULL);
  DeletePlayer_descriptor_ = file->message_type(0);
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_MessageDeletePlayer_2eproto);
}
...
void protobuf_ShutdownFile_MessageDeletePlayer_2eproto() {
  delete DeletePlayer::default_instance_;
  delete DeletePlayer_reflection_;
}

void protobuf_AddDesc_MessageDeletePlayer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\031MessageDeletePlayer.proto\022\007Message\"\033\n\014"
    "DeletePlayer\022\013\n\003pid\030\001 \001(\003", 65);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessageDeletePlayer.proto", &protobuf_RegisterTypes);
  DeletePlayer::default_instance_ = new DeletePlayer();
  DeletePlayer::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_MessageDeletePlayer_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_MessageDeletePlayer_2eproto {
  StaticDescriptorInitializer_MessageDeletePlayer_2eproto() {
    protobuf_AddDesc_MessageDeletePlayer_2eproto();
  }
} static_descriptor_initializer_MessageDeletePlayer_2eproto_;
...
const DeletePlayer& DeletePlayer::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessageDeletePlayer_2eproto();
