...
void protobuf_AssignDesc_MessagePlayerAttribInt_2eproto() {
  protobuf_AddDesc_MessagePlayerAttribInt_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "MessagePlayerAttribInt.proto");
  GOOGLE_CHECK(file != NULL);
  PlayerAttribInt_descriptor_ = file->message_type(0);
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_MessagePlayerAttribInt_2eproto);
}
...
void protobuf_AddDesc_MessagePlayerAttribInt_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\034MessagePlayerAttribInt.proto\022\007Message\""
    ";\n\017PlayerAttribInt\022\013\n\003pid\030\001 \001(\003\022\014\n\004attr\030"
    "\002 \001(\005\022\r\n\005value\030\003 \001(\005", 100);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessagePlayerAttribInt.proto", &protobuf_RegisterTypes);
  PlayerAttribInt::default_instance_ = new PlayerAttribInt();
  PlayerAttribInt::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_MessagePlayerAttribInt_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_MessagePlayerAttribInt_2eproto {
  StaticDescriptorInitializer_MessagePlayerAttribInt_2eproto() {
    protobuf_AddDesc_MessagePlayerAttribInt_2eproto();
  }
} static_descriptor_initializer_MessagePlayerAttribInt_2eproto_;
...
const PlayerAttribInt& PlayerAttribInt::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessagePlayerAttribInt_2eproto();
