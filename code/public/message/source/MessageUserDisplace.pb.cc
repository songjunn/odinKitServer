...
void protobuf_AssignDesc_MessageUserDisplace_2eproto() {
  protobuf_AddDesc_MessageUserDisplace_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "MessageUserDisplace.proto");
  GOOGLE_CHECK(file != NULL);
  UserDisplace_descriptor_ = file->message_type(0);
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_MessageUserDisplace_2eproto);
}
...
void protobuf_AddDesc_MessageUserDisplace_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\031MessageUserDisplace.proto\022\007Message\"\033\n\014"
    "UserDisplace\022\013\n\003uid\030\001 \001(\003", 65);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessageUserDisplace.proto", &protobuf_RegisterTypes);
  UserDisplace::default_instance_ = new UserDisplace();
  UserDisplace::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_MessageUserDisplace_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_MessageUserDisplace_2eproto {
  StaticDescriptorInitializer_MessageUserDisplace_2eproto() {
    protobuf_AddDesc_MessageUserDisplace_2eproto();
  }
} static_descriptor_initializer_MessageUserDisplace_2eproto_;
...
const UserDisplace& UserDisplace::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessageUserDisplace_2eproto();
