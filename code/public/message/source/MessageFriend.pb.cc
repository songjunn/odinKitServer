...
void protobuf_AssignDesc_MessageFriend_2eproto() {
  protobuf_AddDesc_MessageFriend_2eproto();
  ...
  static const int Friend_offsets_[5] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Friend, pid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Friend, name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Friend, level_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Friend, templateid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Friend, fighter_),
  };
  Friend_reflection_ =
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_MessageFriend_2eproto);
}
...
void protobuf_AddDesc_MessageFriend_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\023MessageFriend.proto\022\007Message\"W\n\006Friend"
    "\022\013\n\003pid\030\001 \001(\003\022\014\n\004name\030\002 \001(\t\022\r\n\005level\030\003 \001"
    "(\005\022\022\n\ntemplateid\030\004 \001(\005\022\017\n\007fighter\030\005 \001(\005", 119);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessageFriend.proto", &protobuf_RegisterTypes);
  Friend::default_instance_ = new Friend();
  Friend::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_MessageFriend_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_MessageFriend_2eproto {
  StaticDescriptorInitializer_MessageFriend_2eproto() {
    protobuf_AddDesc_MessageFriend_2eproto();
  }
} static_descriptor_initializer_MessageFriend_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int Friend::kPidFieldNumber;
const int Friend::kNameFieldNumber;
const int Friend::kLevelFieldNumber;
const int Friend::kTemplateidFieldNumber;
const int Friend::kFighterFieldNumber;
#endif  // !_MSC_VER
...
const Friend& Friend::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessageFriend_2eproto();
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_fighter;
        break;
      }
...
void Friend::SerializeWithCachedSizes(
  ...
  // optional int32 fighter = 5;
  if (has_fighter()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(5, this->fighter(), output);
  }
...
::google::protobuf::uint8* Friend::SerializeWithCachedSizesToArray(
  ...
  // optional int32 fighter = 5;
  if (has_fighter()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(5, this->fighter(), target);
  }
