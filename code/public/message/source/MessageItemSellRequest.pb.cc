...
void protobuf_AssignDesc_MessageItemSellRequest_2eproto() {
  protobuf_AddDesc_MessageItemSellRequest_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "MessageItemSellRequest.proto");
  GOOGLE_CHECK(file != NULL);
  ItemSellRequest_descriptor_ = file->message_type(0);
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_MessageItemSellRequest_2eproto);
}
...
void protobuf_AddDesc_MessageItemSellRequest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\034MessageItemSellRequest.proto\022\007Message\""
    "!\n\017ItemSellRequest\022\016\n\006itemid\030\001 \001(\003", 74);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessageItemSellRequest.proto", &protobuf_RegisterTypes);
  ItemSellRequest::default_instance_ = new ItemSellRequest();
  ItemSellRequest::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_MessageItemSellRequest_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_MessageItemSellRequest_2eproto {
  StaticDescriptorInitializer_MessageItemSellRequest_2eproto() {
    protobuf_AddDesc_MessageItemSellRequest_2eproto();
  }
} static_descriptor_initializer_MessageItemSellRequest_2eproto_;
...
const ItemSellRequest& ItemSellRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessageItemSellRequest_2eproto();
