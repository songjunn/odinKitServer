...
enum MsgDefine {
  ...
  MSG_GAMEOBJ_OBJFIELD_SET = 202,
  MSG_GAMEOBJ_MAPFIELD_SET = 203,
  MSG_GAMEOBJ_MAPFIELD_ADD = 204,
  MSG_GAMEOBJ_MAPFIELD_DEL = 205,
  MSG_GAMEOBJ_SYNC = 206,
  MSG_GAMEOBJ_SYNC_OBJFIELD = 207,
  MSG_GAMEOBJ_SYNC_MAPFIELD = 208,
  MSG_GAMEOBJ_SYNC_FINISH = 209,
  MSG_GAMEOBJ_REQUEST = 210,
