	...
	m_nAllocationCount( nInitAllocationCount ), m_nGrowSize( nGrowSize )
{
	...
	{
		m_pMemory = (BlockHeader_t*)MemAlloc( sizeof(BlockHeader_t) + m_nAllocationCount * sizeof(T) );
...
void CUtlFixedMemory<T>::Grow( int num )
{
	...
	BlockHeader_t *pHeader = (BlockHeader_t*)MemAlloc( sizeof(BlockHeader_t) + nNewAllocationCount * sizeof(T) );
